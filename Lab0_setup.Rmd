...
practical component of STATS366/BIOS221. You will learn how to install or update
...
the silicon Macs 
you will need to choose the **R-4.3.1-arm64.pkg**, if you have an older Mac with an intel chip, you can download
**R-4.3.1-x86_64.pkg**.

It is best to keep the same version installed all through the quarter, even if there is an available update in November.
...
The most current release of Bioconductor is 3.17 which works with R 4.3 and above.
...
```{r, eval=FALSE}
BiocManager::install(c("AnnotationDbi", "Biostrings"))
```
